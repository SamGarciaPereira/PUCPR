...
def banheiroSensors():
    sensoresBanheiro = {
        "Sensor de Umidade": "45%",
        "Sensor de Temperatura": "20°C",
        "Sensor de Movimento: ": "Ativo",
    }
    return render_template(
        "/banheiro/sensorsBanheiro.html", sensoresBanheiro=sensoresBanheiro
    )
...
def banheiroActuators():
    atuadoresBanheiro = {
        "Exaustor": "Ativo",
        "Aquecedor de água": "40°C",
        "Válvula automática": "Em pausa",
    }
    return render_template(
        "/banheiro/actuatorsBanheiro.html", atuadoresBanheiro=atuadoresBanheiro
    )
...
def quartoSensors():
    sensoresQuarto = {
        "Sensor de Presença": "Aguardando ativação",
        "Sensor de Temperatura": "20°C",
        "Sensor de Luminosidade": "300 lux",
    }
...
def quartoActuators():
    atuadoresQuarto = {
        "Lâmpada Inteligente": "Ativo",
        "Ar Condicionado": "10°C",
        "Cortina Automática": "Fechada",
    }
    return render_template(
        "/quarto/actuatorsQuarto.html", atuadoresQuarto=atuadoresQuarto
    )
