...
def exe1():
    print(very_bad_hash("Isso é um teste de criptografia", 8))
    print(very_bad_hash("Isto é um teste de criptografia", 8))
    print(very_bad_hash("Itso é um teste de criptografia", 8))
...
def exe2():
    print(polinomial_hash("Isso é um teste de criptografia", 16))
    print(polinomial_hash("Isto é um teste de criptografia", 16))
    print(polinomial_hash("Itso é um teste de criptografia", 16))
...
def exe3():
    print("teste com md5")
    print(calcula_hash_string("Isso é um teste de criptografia", hashlib.md5))
    print(calcula_hash_string("Isto é um teste de criptografia", hashlib.md5))
    print(calcula_hash_string("Itso é um teste de criptografia", hashlib.md5))

    print("teste com sha256")
    print(calcula_hash_string("Isso é um teste de criptografia", hashlib.sha256))
    print(calcula_hash_string("Isto é um teste de criptografia", hashlib.sha256))
    print(calcula_hash_string("Itso é um teste de criptografia", hashlib.sha256))
...
def exe4():
    ...
    hash_md5 = calcula_hash_string(" ", hashlib.md5)
    hash_sha256 = calcula_hash_string(" ", hashlib.sha256)
    
    print(len(calcula_hash_string("Isso é um teste de c", hashlib.md5)))
    print("tamanho do hash sha256")
    print(len(calcula_hash_string("Isso é um teste de criptografia", hashlib.sha256)))
