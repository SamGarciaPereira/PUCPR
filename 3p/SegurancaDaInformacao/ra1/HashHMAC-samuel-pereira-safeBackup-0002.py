...
def exe2():
    print(polinomial_hash("Isso é um teste de criptografia", 32))
    print(polinomial_hash("Isto é um teste de criptografia", 32))
    print(polinomial_hash("Itso é um teste de criptografia", 32))
