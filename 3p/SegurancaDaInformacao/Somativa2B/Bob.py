...
def fase1_Autenticacao():
    ...
    senha_salgada = senha  # TODO: modifique essa linha CHECK
    senha_salgada = HL.calculaHASH(senha + salt)[1]

    cs_BOB = "NONCE"  # TODO: modifique essa linha CHECK
    cs_BOB = HL.geraNonce(128)[1].decode()

    prova_para_ALICE = senha  # TODO: modifique essa linha CHECK
    ...
    local_hash = senha_salgada  # TODO: modifique essa linha CHECK
