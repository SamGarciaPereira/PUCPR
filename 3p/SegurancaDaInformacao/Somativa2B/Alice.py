...
def fase1_Autenticacao(senhas, salts):
    ...
    cs_ALICE = "NONCE"  # TODO: modifique essa linha CHECK
    cs_ALICE = HL.geraNonce(128)[1].decode()

    salt = "SALT"  # TODO: modifique essa linha CHECK
    salt = salts[user]
    ...
    data, addr = s.recvfrom(
        1024
    )  # mensagem esperada: ['CHALLENGE_RESPONSE', 'NONCE', 'HASH_SENHA' ]
    print("RECEBI: ", data)
    ...
    local_HASH = senhas[user]  # TODO: modifique essa linha CHECK
    local_HASH = HL.calculaHASH(senhas[user] + cs_ALICE)[1]

    prova_para_bob = senhas[user]  # TODO: modifique essa linha CHECK
    prova_para_bob = HL.calculaHASH(senhas[user] + cs_BOB)[1]
