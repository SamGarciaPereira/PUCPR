...
if ativar_MiTM:
    ...
    print(
        "Este cenário não tem MiTM, o cliente está falando diretamente com o servidor"
    )
...
if __name__ == "__main__":
    ...
    user = "samuel"
    senhas, salts = carregarSenhas()
    salt = salts[user]

    testes = ["samuel123", "SAMUEL"]

    print("Senha Salgada: ", senhas[user])
    for t in testes:
        print(calculaHASH(t + salt))
    exit()
