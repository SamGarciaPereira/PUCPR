...
# EXERCICIO 1: Copie o cipher do prompt do VSCcode e coloque na variável cipher2x'
# Veja se a descriptografia funciona


cipher2 = b'lI6Jkt0U3YiQ3YmYjomY3ZCIlImS3ZiOiY+ck5WS'  
plain2 = xor_decipher_b64(cipher2, chave)
print('CRIPTO 2:', plain2)
plain2 = ''.join(plain2)  
print('DECRIPTO 2:', plain2)
